...
"""Convert the dataset of real camera images with no traffic lights to TFRecord file 
   for object detection API. 

Example usage:
    python create_real_camera_tf_record_no_annotations.py --data_dir=<directory of images> \
